...
.PARAMETER psexecFilePath
    ...
    Default Path: "C:\PSExec\PSExec.exe"

.EXAMPLE
    .\Install-Update.ps1 -computers Computer1 -hotFixName "ms15-067-x86.msu"

    Description:

        Installs HotFix "ms15-067-x86.msu" to the computer named "Computer1"

.EXAMPLE
    .\Install-Update.ps1 -computers 192.168.112.125 -hotFixName "ms15-067-x86.msu"

    Description:

        Installs HotFix "ms15-067-x86.msu" to the computer with IP "192.168.112.125"
