...
"I'm testing the new POSH Nap provider...", "I need this!",
...
do {
     ...
     if ($ProgressBar ) {
          ...
          Clear-Host
          Write-Host "Ssshhhh....`n"

          # Trim off the milliseconds
          Write-Host ($wake - (Get-Date)).ToString().Substring(0, 8) -NoNewline "`n"
     }
