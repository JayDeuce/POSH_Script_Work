<#
	!! NOTE: Currently Configured for use as a Scheduled task on User shares !!
...
$PathAFN = "\\Server1\1_users"
$PathAFS = "\\Server1\2_users"
$PathBDE = "\\Server1\3_users"
$AFNReport = "\\Server1\TECHNICAL\srvr_reports\UserShareMonitoring\1_UFS-$Date.html"
$AFSReport	= "\\Server1\TECHNICAL\srvr_reports\UserShareMonitoring\2_UFS-$Date.html"
$BDEReport	= "\\Server1\TECHNICAL\srvr_reports\UserShareMonitoring\3_UFS-$Date.html"
# Build Notification Email for Send-MailMessage Command
$Recipients = '"emailaddress"'
$Sender = '"User Share Monitoring Script <noreply@noreply.mil>"'
$SMTPServer = "11.1.1.1"
$Subject = "New User Share Size Monitoring Report Created - $Date"
$Body = @"
Good Morning,

A New Report on the size of the User Shares has been created and saved to:

	\\Server1\TECHNICAL\srvr_reports\UserShareMonitoring

Please look over the report for your AOR and ensure all users are compliant.

Any question or issues please contact the KMO Officer at (555) 555-5555
...
getFolderSize $Path1 $1Report
getFolderSize $Path2 $2Report
getFolderSize $Path3 $3Report
