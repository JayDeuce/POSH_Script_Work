...
#Get-ADGroupMembers "Admins"

Get-ADGroupMembers "Admins" | Select-Object -ExpandProperty Name

$test = Get-ADGroupMembers "Admins" | Select-Object -ExpandProperty name

if ($test.Contains("Durant")) {
     Write-Host "Heck ya!!"
}
else {
     Write-Host "Hell NO!!"
