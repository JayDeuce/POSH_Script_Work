1. Place the unlock-BLDrives.ps1 in the folder C:\Viper

2. Import UnlockBL.xml into the scheduled tasks manager and ensure the user name is correct to run tasks.
